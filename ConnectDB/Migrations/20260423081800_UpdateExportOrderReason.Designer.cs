...
namespace ConnectDB.Migrations
{
    ...
    [Migration("20260423081800_UpdateExportOrderReason")]
    partial class UpdateExportOrderReason
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ConnectDB.Model.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ConnectDB.Model.OrderDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ConnectDB.Model.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ConnectDB.Model.Order", b =>
                {
                    b.HasOne("ConnectDB.Model.User", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("ConnectDB.Model.OrderDetail", b =>
                {
                    b.HasOne("ConnectDB.Model.Order", "Order")
                        .WithMany("Details")
